...
Turn in [QT661 Hints of a New Plague? Part 5]
Turn in [QT602 Magical Analysis], accept [QA603 Ansirem's Key]
Do [QC500 Crushridge Bounty]
Hearth to [H Southshore]
Turn in [QT500 Crushridge Bounty], accept [QA504 Crushridge Warmongers]
Do [QC540 Preserving Knowledge], [QC504 Crushridge Warmongers] & [QC543 The Perenolde Tiara]
Do [QC512 Noble Deaths]
Kill [QC537,2 Nagaz] for [QC537 Dark Council] and loot the Ensorcelled Parchment from the Worn Wooden Chest, accept [QA551 The Ensorcelled Parchment]
**Now is the ideal time to do an SM run**
After SM, Hearth to [H Southshore]
Turn in [QT537 Dark Council] & [QT512 Noble Deaths]
Turn in [QT551 The Ensorcelled Parchment] & [QT540 Preserving Knowledge], accept [QA554 Stormpike's Deciphering] & [QA542 Return to Milton]
Turn in [QT1053 In The Name of the Light]
Turn in [QT504 Crushridge Warmongers]
Run to[OC] The Hinterlands
Grab the FP
...
Turn in [QT542 Return to Milton] & [QT543 The Perenolde Tiara]
Make sure you get 'Frost Oil' and 'Gyrochronatom' off Auction House/[V Vendor] or out of the Bank before heading to Badlands
Turn in [QT697 Malin's Request]
Fly to [F Loch] Modan
Accept [QA2500 Badlands Reagent Run]
Accept [QA704 Agmond's Fate]
Run south into Badlands
]],'MarkyMark')